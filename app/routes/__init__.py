...
from .consommation_routes import bp_consommation
...
blueprints = [bp_user, bp_role, bp_auth, bp_direction, bp_rubrique, bp_groupement, bp_budget, bp_consommation, bp_projet_detail, bp_report, bp_prediction]
